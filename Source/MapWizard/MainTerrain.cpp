                                     ...
                                     FDebugParams& debug_params)
{
	...
	if (FoundActors.Num() > 0)
	{
		...
		TerrainGen gen(MapParams, ResidentialHousesParams, LuxuryHousesParams, SlumsHousesParams, RoyalDistrictParams);
...
void AMainTerrain::draw_all()
{
	...
	AProceduralBlockMeshActor* Base = GetWorld()->SpawnActor<AProceduralBlockMeshActor>(
		AProceduralBlockMeshActor::StaticClass());
